export const objects: Objects = {
  ...
  block: {
    ...
    properties: {
      id: {
        type: 'string',
        description: 'The ID of the block. The ID is dynamically generated by Shopify and is subject to change. You should avoid relying on a literal value of this ID.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/block/id)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      },
      settings: {
        type: 'any',
  ...
  closest: {
    ...
    global: true,
    description: "A drop that holds resources of different types that are the closest to the current context This drop is used to hold resources of different types that are the closest to the current context. These resources can be of type `product`, `collection`, `article`, `blog`, `page`, or `metaobject`.\nThe resources of different types within the closest drop can be:\n - The currently rendered section or theme block resource setting of the same type\n - The currently rendered theme block's ancestor resource setting of the same type\n - The currently rendered template resource of the same type\n - Assigned via {% content_for %} tag\n\n\n\n**Tip**\n\n> To learn about how closest drop in theme settings can be used, refer to [Dynamic sources](https://shopify.dev/themes/architecture/blocks/theme-blocks/dynamic-sources).\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/closest)\n\n\nLast Updated: 2nd February 2025\n\n\n",
    type: 'object',
    properties: {
      product: {
        type: 'object',
        description: 'Closest product resource The product resource that is the closest to the current context.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/closest/product)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'product'
      },
      collection: {
        type: 'object',
        description: 'Closest collection resource The collection resource that is the closest to the current context.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/closest/collection)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'collection'
      },
      article: {
        type: 'object',
        description: 'Closest article resource The article resource that is the closest to the current context.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/closest/article)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'article'
      },
      blog: {
        type: 'object',
        description: 'Closest blog resource The blog resource that is the closest to the current context.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/closest/blog)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'blog'
      },
      page: {
        type: 'object',
        description: 'Closest page resource The page resource that is the closest to the current context.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/closest/page)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'page'
      },
      metaobject: {
        type: 'object',
        description: 'Closest metaobject resources The metaobject resources that are the closest to the current context.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/closest/metaobject)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'metaobject'
      }
    }
  },
  ...
  company: {
    ...
    properties: {
      ...
      external_id: {
        type: 'string',
        description: 'The external ID of the company. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/company/external_id)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      },
      available_locations: {
        type: 'array',
      ...
      available_locations_count: {
        type: 'number',
        description: "The number of company locations associated with the customer's company. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/company/available_locations_count)\n\n\nLast Updated: 2nd February 2025\n\n\n"
      },
      metafields: {
        type: 'array',
  ...
  company_location: {
    ...
    properties: {
      ...
      external_id: {
        type: 'string',
        description: 'The external ID of the location. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/company_location/external_id)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      },
  ...
  customer: {
    ...
    properties: {
      ...
      payment_methods: {
        type: 'array',
        description: "The customer's saved payment methods. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/customer/payment_methods)\n\n\nLast Updated: 2nd February 2025\n\n\n",
        scope: 'customer_payment_method'
      },
      'b2b?': {
        type: 'boolean',
      ...
      'has_avatar?': {
        type: 'boolean',
        description: "Returns `true` if an avatar is associated with a customer. Returns `false` if not. A customer may have an avatar associated with their account, which can be displayed in the storefront.\n\n\n\n**Tip**\n\n> Use with the [`avatar`](https://shopify.dev/docs/api/liquid/filters/avatar) filter to render the customer's avatar.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/customer/has_avatar?)\n\n\nLast Updated: 2nd February 2025\n\n\n"
      }
    }
  },
  customer_payment_method: {
    summary: "A customer's saved payment method.",
    description: "A customer's saved payment method. A payment method that a customer has saved to their account for reuse (e.g. a credit card).\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/customer_payment_method)\n\n\nLast Updated: 2nd February 2025\n\n\n",
    type: 'object',
    properties: {
      payment_instrument_type: {
        type: 'string',
        description: 'The instrument type of the payment method (e.g credit_card). \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/customer_payment_method/payment_instrument_type)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      },
      token: {
        type: 'string',
        description: 'The identifier for the payment method. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/customer_payment_method/token)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      }
    }
  },
  discount_allocation: {
  ...
  filter_value: {
    ...
    properties: {
      ...
      image: {
        type: 'object',
        description: 'The visual representation of the filter value when an image is used. Returns an [image](https://shopify.dev/docs/api/liquid/objects/image) drop for the filter value.\nRequires the [filter presentation](https://shopify.dev/docs/api/liquid/objects/filter#filter-presentation) to be `image` and for an image to be available. Otherwise, returns `nil`.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/filter_value/image)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'image'
      }
    }
  },
  ...
  product_option_value: {
    ...
    properties: {
      ...
      swatch: {
        type: 'object',
        description: 'Returns a [swatch](https://shopify.dev/docs/api/liquid/objects/swatch) drop for the product option value. If there is no saved `color` or `image` content for the swatch, then the return value is `nil`. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/product_option_value/swatch)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'swatch'
      },
      selected: {
        type: 'boolean',
  ...
  variant: {
    ...
    properties: {
      ...
      requires_selling_plan: {
        type: 'boolean',
        description: "Returns `true` if the variant's product is set to require a `selling_plan` when being added to the cart. Returns `false` if not. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/variant/requires_selling_plan)\n\n\nLast Updated: 2nd February 2025\n\n\n"
      }
    }
  },
  ...
  routes: {
    ...
    properties: {
      ...
      storefront_login_url: {
        type: 'string',
        description: '[New customer accounts](https://help.shopify.com/en/manual/customers/customer-accounts/new-customer-accounts) login page. Redirects to the storefront page the customer was on before visiting the login page. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/routes/storefront_login_url)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      }
    }
  },
  script: {
  ...
  shipping_method: {
    ...
    properties: {
      ...
      price_with_discounts: {
        type: 'number',
        description: "The price of the shipping method in the currency's subunit, after discounts have been applied, including order level discounts. The value is output in the customer's local (presentment) currency.\n\nFor currencies without subunits, such as JPY and KRW, tenths and hundredths of a unit are appended. For example, 1000 Japanese yen is output as 100000.\n\n\n\n**Tip**\n\n> Use [money filters](https://shopify.dev/docs/api/liquid/filters/money-filters) to output a formatted price.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/shipping_method/price_with_discounts)\n\n\nLast Updated: 2nd February 2025\n\n\n"
      },
      price: {
        type: 'number',
        description: "⚠️ **DEPRECATED** ⚠️\n\nDeprecated because the price did not include order level discounts.\n\nThe `shipping_line.price` property has been replaced by [`shipping_line.price_with_discounts`](/docs/api/liquid/objects/shipping_method#shipping_method-price_with_discounts).\n\n---\n\nThe price of the shipping method in the currency's subunit, after discounts have been applied. The value is output in the customer's local (presentment) currency.\n\nFor currencies without subunits, such as JPY and KRW, tenths and hundredths of a unit are appended. For example, 1000 Japanese yen is output as 100000.\n\n\n\n**Tip**\n\n> Use [money filters](https://shopify.dev/docs/api/liquid/filters/money-filters) to output a formatted price.\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/shipping_method/price)\n\n\nLast Updated: 2nd February 2025\n\n\n"
      },
      handle: {
        type: 'string',
  ...
  taxonomy_category: {
    ...
    description: 'The taxonomy category for a product \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/taxonomy_category)\n\n\nLast Updated: 2nd February 2025\n\n\n',
    type: 'object',
    properties: {
      gid: {
        type: 'string',
        description: 'The public node ID for the category, formatted as a Shopify GID. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/taxonomy_category/gid)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      },
      id: {
        type: 'string',
        description: 'The public node ID for the category \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/taxonomy_category/id)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      },
      name: {
        type: 'string',
        description: 'The localized category name \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/taxonomy_category/name)\n\n\nLast Updated: 2nd February 2025\n\n\n'
      },
      ancestors: {
        type: 'array',
        description: 'All parent nodes of the current taxonomy category. \n\n\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/taxonomy_category/ancestors)\n\n\nLast Updated: 2nd February 2025\n\n\n',
        scope: 'taxonomy_category'
      }
    }
  },
  ...
  powered_by_link: {
    summary: 'Creates an HTML link element that links to a localized version of `shopify.com`, based on the locale of the store.',
    global: true,
    description: 'Creates an HTML link element that links to a localized version of `shopify.com`, based on the locale of the store. \n\n\n\n#### Example\n\n```liquid\n\n{{ powered_by_link }}\n\n```\n\n---\n\n[Shopify Liquid](https://shopify.dev/docs/api/liquid/objects/powered_by_link)\n\n\nLast Updated: 2nd February 2025\n\n\n',
    const: true
  },
